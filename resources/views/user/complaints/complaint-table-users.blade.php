...
{{-- @if (Route::currentRouteName() == 'user.all.complaint')
    @section('title','Semua Pengaduan')
@elseif(Route::currentRouteName() == 'user.pending.complaint')
    @section('title','Semua Pengaduan Pending')
@elseif(Route::currentRouteName() == 'user.proses.complaint')
    @section('title','Semua Pengaduan Process')    
@elseif(Route::currentRouteName() == 'user.selesai.complaints')
    @section('title','Semua Pengaduan Success')
@endif --}}
