                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="name" class="form-control @error('name') is-invalid @enderror" value="{{auth()->user()->name}}" placeholder="Nama Lengkap" name="name" disabled readonly required>
                                            @error('name')
                                    ...
                                    <div class="col-md-6 col-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="telp" class="form-control @error('telp') is-invalid @enderror" value="{{ auth()->user()->telp }}" placeholder="Nomor Telepon" name="telp" readonly disabled required>
                                            @error('telp')
                                                <div class="invalid-feedback">{{$message}}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6 col-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="email" id="email" class="form-control @error('email') is-invalid @enderror" value="{{auth()->user()->email}}" placeholder="Alamat Email" name="email" readonly disabled required>
                                            @error('email')
                                                <div class="invalid-feedback">{{$message}}</div>
                                            @enderror
                                        </div>
